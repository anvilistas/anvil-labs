...
_script = """
'use strict';
(()=>{function b(e){let{builtin:{BaseException:t},ffi:{toJs:r}}=Sk;function s(){let o={resolve:()=>{},reject:()=>{}};return o.promise=new Promise((i,l)=>{o.resolve=i,o.reject=l}),o}let a={};e.registerFn=(o,i)=>{a[o]=i},e.moduleLoaded=s();function n(){e.task_state=new Proxy({},{set(o,i,l){return o[i]===l||(o[i]=l,e.postMessage({type:"STATE",state:{...o}})),!0}})}let c=new Map;e.fetchModule=o=>{let i=crypto.randomUUID();e.postMessage({type:"IMPORT",id:i,filename:o});let l=s();return c.set(i,l),l.promise},e.onmessage=async o=>{let{data:i}=o;switch(i.type){case"CALL":{await e.moduleLoaded.promise,n();let{id:l,fn:d,args:f,kws:g}=i;console.debug(`RPC call ${l}:`,d,f);let k=a[d],_,m,u,y;if(e.currentTask={id:l,fn:d},!k)m="RuntimeError",u=[`No handler registered for '${i.fn}'`];else try{_=await k(f,g)}catch(p){p instanceof t?(u=r(p.args),m=p.tp$name,y=p.traceback):(m=p.constructor?.name??"<unknown>",u=p.message?[p.message]:[])}e.currentTask=null;try{stopExecution=!1,e.postMessage({type:"RESPONSE",id:i.id,value:_,errorType:m,errorArgs:u,errorTb:y})}catch(p){console.error(p,"Failed to post RPC response:",_,p)}break}case"KILL":stopExecution||(stopExecution=!0);break;case"MODULE":{let{id:l,content:d}=i,{resolve:f}=c.get(l);c.delete(l),f(d)}}}}function T(){let{ffi:{proxy:e,toPy:t},abstr:{setUpModuleMethods:r,objectSetItem:s},misceval:{promiseToSuspension:a,chain:n}}=Sk,c={__name__:t("js"),window:e(self)};async function o(i){let l=await new Function("return import("+JSON.stringify(i.toString())+")").call(null);return e(l)}return r("js",c,{await_promise:{$meth(i){let l=i.valueOf();return l instanceof Promise||l&&l.then&&typeof l.then=="function"?n(a(l),d=>t(d,{dictHook:f=>e(f)})):i},$flags:{OneArg:!0}},import_from:{$meth(i){return a(o(i))},$flags:{OneArg:!0}}}),s(Sk.sysmodules,t("anvil.js.window"),c.window),c}function D(){let{ffi:{toPy:e,toJs:t},abstr:{setUpModuleMethods:r}}=Sk,s={__name__:new e("json")};return r("js",s,{dumps:{$meth(a){return new e(JSON.stringify(t(a)))},$flags:{OneArg:!0}},loads:{$meth(a){return e(JSON.parse(a.toString()))},$flags:{OneArg:!0}}}),s}function P(){let e=document.getElementsByTagName("script");return Array.from(e).find(t=>t.src?.includes("skulpt.min.js")).src}function C(){Sk.configure({output(e){return self.postMessage({type:"OUT",message:e})},yieldLimit:300,syspath:["app"],read(e){let t=self.anvilFiles[e];return t!==void 0?t:Sk.misceval.promiseToSuspension(self.fetchModule(e).then(r=>{if(r==null)throw"No module named "+e;return r}))}})}function M(){let{builtin:{RuntimeError:e},ffi:{toJs:t,toPy:r},misceval:{tryCatch:s,chain:a,Suspension:n,asyncToPromise:c,buildClass:o,callsimArray:i}}=Sk;Sk.builtins.self=Sk.builtins.worker=r(self);let l=o({__name__:"anvil_labs.web_worker"},()=>{},"WorkerTaskKilled",[e]),d=Sk.sysmodules.quick$lookup(r("__main__")).$d;for(let[f,g]of Object.entries(d))g.tp$call&&self.registerFn(f,(k,_)=>{k=k.map(u=>r(u)),_=Object.entries(_).map(([u,y])=>[u,r(y)]).flat();let m=s(()=>a(g.tp$call(k,_),u=>t(u)),u=>{throw u});return m instanceof n?c(()=>m,{"*":()=>{if(stopExecution){let{id:u,fn:y}=self.currentTask;throw i(l,[`<WorkerTask '${y}' (${u})> Killed`])}}}):m})}var $=`
